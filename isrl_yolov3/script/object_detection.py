...
flags.DEFINE_string('classes', '/home/isrl/yolov3-tf2/data/coco.names', 'path to classes file')
flags.DEFINE_string('weights', '/home/isrl/yolov3-tf2/checkpoints/yolov3.tf',
